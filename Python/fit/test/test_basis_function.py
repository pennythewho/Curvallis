...
class TestFitBasisFunction(ut.TestCase):
    ...
    def test_get_basis_function_simple_knots_cp0(self):
        p = 2
        m = 4
    ...
    def test_get_basis_function_multiple_knots_cp0(self):
        p = 2
    ...
    def test_get_basis_function_multiple_knots_cp1(self):
        p = 2
        knots = np.append(np.append(np.repeat(0, p + 1), [.3, .5, .5, .6]), np.repeat(1, p + 1))
        m = len(knots) - 1
        i = 1
    ...
    def test_get_basis_function_multiple_knots_cp2(self):
        p = 2
        knots = np.append(np.append(np.repeat(0, p + 1), [.3, .5, .5, .6]), np.repeat(1, p + 1))
        m = len(knots) - 1
        i = 2
    ...
    def test_get_basis_function_multiple_knots_cp3(self):
        p = 2
        knots = np.append(np.append(np.repeat(0, p + 1), [.3, .5, .5, .6]), np.repeat(1, p + 1))
        m = len(knots) - 1
        i = 3
    ...
    def test_get_basis_function_multiple_knots_cp4(self):
        p = 2
        knots = np.append(np.append(np.repeat(0, p + 1), [.3, .5, .5, .6]), np.repeat(1, p + 1))
        m = len(knots) - 1
        i = 4
    ...
    def test_get_basis_function_multiple_knots_cp5(self):
        p = 2
        knots = np.append(np.append(np.repeat(0, p + 1), [.3, .5, .5, .6]), np.repeat(1, p + 1))
        m = len(knots) - 1
        i = 5
    ...
    def test_get_basis_function_multiple_knots_cp6(self):
        p = 2
        knots = np.append(np.append(np.repeat(0, p + 1), [.3, .5, .5, .6]), np.repeat(1, p + 1))
        m = len(knots) - 1
        i = 6
